...
namespace Makc2021.Layer2.DBs.SqlServer.Queries.Tree.Trigger
{
	/// <summary>
	/// База данных "Microsoft SQL Server". Запрос триггера дерева. Построитель.
	/// </summary>
	public class SqlServerTreeTriggerQueryBuilder : TreeTriggerQueryBuilder
	{
