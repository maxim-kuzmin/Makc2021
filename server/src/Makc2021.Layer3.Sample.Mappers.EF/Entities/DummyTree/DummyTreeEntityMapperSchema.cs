...
{
    /// <summary>
    /// Схема сущности "DummyTree" для сопоставителя.
    /// </summary>
    public class DummyTreeEntityMapperSchema : MapperSchema<DummyTreeEntityMapperObject>
    {
        #region Constructors

        /// <inheritdoc/>
        public DummyTreeEntityMapperSchema(EntitiesSettings entitiesSettings)
        ...
        /// <inheritdoc/>
        public sealed override void Configure(EntityTypeBuilder<DummyTreeEntityMapperObject> builder)
        {
            Sample.Entities.DummyTree.DummyTreeEntitySetting setting = EntitiesSettings.DummyTree;
