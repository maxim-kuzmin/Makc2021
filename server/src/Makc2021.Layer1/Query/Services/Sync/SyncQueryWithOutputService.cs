...
namespace Makc2021.Layer1.Query.Services.Sync
{
    ...
    public class SyncQueryWithOutputService<TOutput> : QueryWithOutputService<TOutput>
    {
        ...
        /// </summary>
        public Func<TOutput> FunctionToExecute { get; protected set; }
        ...
        public SyncQueryWithOutputService(Func<TOutput> functionToExecute, IErrorsResource resourceOfErrors)
