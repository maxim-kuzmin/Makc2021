...
using Makc2021.Layer2.DBs.PostgreSql.Queries.Tree.Calculate;
using Makc2021.Layer2.Queries.Tree.Trigger;
using Makc2021.Layer2.Trigger;
using System.Linq;
using System.Text;

namespace Makc2021.Layer2.DBs.PostgreSql.Queries.Tree.Trigger
{
    /// <summary>
    /// База данных "PostgreSQL". Запрос триггера дерева. Построитель.
    /// </summary>
    public class PostgreSqlTreeTriggerQueryBuilder : TreeTriggerQueryBuilder
	{
