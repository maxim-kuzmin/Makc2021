...
{
    /// <summary>
    /// Источник "Sample". Сущность "DummyMain". Загрузчик.
    /// </summary>
    public class SampleDummyMainEntityLoader : Loader<SampleDummyMainEntityObject>
    {
        #region Constructors
        ...
        public SampleDummyMainEntityLoader(SampleDummyMainEntityObject data = null)
                : base(data ?? new SampleDummyMainEntityObject())
        {
        }
        ...
        public void LoadDataFrom(SampleDummyMainEntityObject source, HashSet<string> props = null)
        {
