...
{
    /// <summary>
    /// Источник "Sample". Сущность "DummyTree". Загрузчик.
    /// </summary>
    public class SampleDummyTreeEntityLoader : Loader<SampleDummyTreeEntityObject>
    {
        #region Constructors
        ...
        public SampleDummyTreeEntityLoader(SampleDummyTreeEntityObject data = null)
            : base(data ?? new SampleDummyTreeEntityObject())
        {
        }
        ...
        public void LoadDataFrom(SampleDummyTreeEntityObject source, HashSet<string> props = null)
        {
